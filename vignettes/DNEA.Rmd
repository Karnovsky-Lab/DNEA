...
data("TEDDY")
data("T1Dmeta")
aminos <- c("alanine", "arginine", "asparagine", "aspartic_acid", "cysteine", "glutamine", 
            "glutamic_acid", "glycine", "histidine", "isoleucine", "leucine", "lysine", "methionine",
            "phenylalanine","proline", "serine", "threonine", "tryptophan", "tyrosine", "valine")
keep <- rownames(TEDDY) %in% aminos
TEDDY <- TEDDY[keep,]
#initiate BiocParallel 
BP_plan <- MulticoreParam(workers = 2, RNGseed = 417, progressbar = TRUE)
...
message("The log-scaled_data expression data will be used for analysis.\n")
