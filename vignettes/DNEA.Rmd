...
*NOTE: To initiate a `DNEAobj` from a `summarizedExperiment-class` or `mass_dataset-class` object, the `sumExp2DNEAobj()` and `massDataset2DNEAobj()` functions can be used, respectively.*
